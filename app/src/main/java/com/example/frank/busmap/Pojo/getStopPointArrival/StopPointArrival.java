package com.example.frank.busmap.Pojo.getStopPointArrival;

import com.example.frank.busmap.Pojo.getBusArrival.BusArrivalResponse;
import com.example.frank.busmap.Pojo.getBusArrival.Timing;

/**
 * Created by frank on 23/02/2018.
 */

public class StopPointArrival implements Comparable<StopPointArrival>
{
    ...
    @Override
    public int compareTo(StopPointArrival a){
        return ((Integer)(a.getTimeToStation()).compareTo(this.getTimeToStation()));
    }
