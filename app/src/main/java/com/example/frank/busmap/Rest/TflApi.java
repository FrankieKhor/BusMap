...
import com.example.frank.busmap.LatLngUtils;
...
public interface TflApi {
    ...
    Call<TicketPrice> getTicketPrice (@Path("StopPointFrom") String from, @Path("StopPointFrom") String to, @Query("app_id") String AppId, @Query("app_key") String ApiKey );
