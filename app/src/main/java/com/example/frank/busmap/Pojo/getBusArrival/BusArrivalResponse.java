...
public class BusArrivalResponse implements Comparable<BusArrivalResponse> {
    ...
    @Override
    public int compareTo(BusArrivalResponse a){
        return ((Integer)(this.getTimeToStation()).compareTo(a.getTimeToStation()));
    }
